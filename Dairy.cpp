...
void namefun(){
	...
	char ch;
	gotoxy(31,4);
	printf("Do you wanna add more data.Press y for that:");
	Sleep(1000);
	fflush(stdin);
	while((ch=getch())=='y'){
		menu();
...
void exitfun(){
	...
	gotoxy(31,6);
	printf("\xDB ANJALI JAIN.");
	gotoxy(31,8);
	printf("\xDB BHANU PRATAP SINGH GEHROLI.");
	gotoxy(31,10);
	printf("\xDB TANUJ SHARMA.");
	gotoxy(31,12);
	printf("\xDB SHERYANSH BHARDWAJ.");
}
void password(void){
	char passwords[20]={"btech"};
	gotoxy(22,2);
	int j;
	int z;
